...
public sealed class DocsContextToolResponseAgent
{
    private static readonly JsonSerializerOptions JsonOptions = new(JsonSerializerDefaults.Web);
    private readonly ChatClientAgent agent;

    public DocsContextToolResponseAgent(ILoggerFactory loggerFactory, IServiceProvider services)
    {
        agent = new ChatClientAgent(
            new DocsContextFormattingChatClient(),
            instructions: "Format DocsContext MCP tool results into concise plain text. Use only supplied data and never invent details.",
            name: "docscontext-tool-agent",
            description: "Converts structured DocsContext MCP payloads into concise human-readable text.",
...
internal sealed class DocsContextFormattingChatClient : IChatClient
{
    private static readonly JsonSerializerOptions JsonOptions = new(JsonSerializerDefaults.Web);
    ...
    )
    {
        ...
        var response = new ChatResponse(
            ...
            {
                AuthorName = "docscontext-tool-agent",
            }
        );
